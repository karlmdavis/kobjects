...
public class XmlReader {
   ...
   /** Text was just read  */
    ...
    private String [] TYPES = {"Start Document", "End Document", 
	...
	if (!name.equals(elementStack [--depth])) 
    ...
    private static final String[] ensureCapacity (String [] arr, 
						  int required) { 
