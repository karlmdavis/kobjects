...
public class CookieModule implements HTTPClientModule
{
	...
	boolean persist;
	try
	    { persist = false;//Boolean.getBoolean("HTTPClient.cookies.save"); 
	    }
	catch (Exception e)
	    { persist = false; }
	...
	try
	    { file = null;//System.getProperty("HTTPClient.cookies.jar"); 
	    }
	catch (Exception e)
	    { }
...
class DefaultCookiePolicyHandler implements CookiePolicyHandler
{
	...
	try
	    { list = null;//System.getProperty("HTTPClient.cookies.hosts.accept"); 
	    }
	catch (Exception e)
	    { list = null; }
