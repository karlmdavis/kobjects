...
public class HTTPConnection implements GlobalConstants, HTTPClientModuleConstants
{
	...
	try		// JDK 1.1 naming
	{
	    String host = null;//System.getProperty("http.proxyHost");
	    if (host == null)
		throw new Exception();		// try JDK 1.0.x naming
	    int port = -1;//Integer.getInteger("http.proxyPort", -1).intValue();
	...
	try
	{
	    String host = null;//System.getProperty("HTTPClient.socksHost");
